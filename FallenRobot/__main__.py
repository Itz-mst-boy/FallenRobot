...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text=" ᴘᴏᴡᴇʀᴇᴅ ʙʏ ", callback_data="source_"),
    ],
    [
        InlineKeyboardButton(
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""*ʜᴇʏ,*\n\n*ᴛʜɪs ɪs ᴍᴜᴋʜᴜsʜɪ ✘ ʀᴏʙᴏᴛ*\n\n*ʜᴇʀᴇ ɪs ɴᴇᴛᴡᴏʀᴋ ʟɪɴᴋ :* [ᴍᴀsᴛᴇʀᴍɪɴᴅ ɴᴇᴛᴡᴏʀᴋ ᴏғғɪᴄɪᴀʟ](https://t.me/mastermind_network_official)\n\n*sᴏ ɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ʀᴇǫᴜᴇsᴛ ᴩʟᴇᴀsᴇ ʟᴇᴛ ᴜs ᴋɴᴏᴡ ᴀᴛ* [ᴡᴏʀʟᴅᴡɪᴅᴇ ғʀɪᴇɴᴅ ᴢᴏɴᴇ](https://t.me/worldwide_friend_zone) *ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴩᴇʀ :* [ᴍᴜᴋᴇsʜ](https://t.me/itz_mst_boy)""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "» ᴍᴜᴋʜᴜsʜɪ ✘ ʀᴏʙᴏᴛ ɪs ᴀʟɪᴠᴇ !")
        except Unauthorized:
            LOGGER.warning(
